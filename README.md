...
### [Microsoft Agent Framework Go](https://github.com/microsoft/agent-framework-go) — 166 merged PRs · 537★

Microsoft's official Go implementation of the Agent Framework. My **166 merged PRs** span runtime correctness across the Anthropic and OpenAI providers, the workflow engine, A2A, and MCP layers — **each shipped with a regression test**. Selected highlights:
...
- [**Microsoft Agent Framework Go**](https://github.com/microsoft/agent-framework-go) — **166 merged PRs** into Microsoft's official Go Agent Framework (537★). See the [featured contribution](#-featured-open-source-contribution) above.
